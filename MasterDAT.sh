...
PROJECT_DIR="/project/"${SLURM_JOB_ACCOUNT//_cpu/}
...
export NCBI_API_KEY=e0a9648272551712054923626410c9135506 #This API key belongs to Aaron, and allows more unfettered access to NCBI servers. Not really necessary any more?
